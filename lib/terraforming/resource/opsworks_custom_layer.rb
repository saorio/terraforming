        ...
        stacks.inject({}) do |resources, stack|
          ...
          stack_layers(stack.stack_id).each do |layer|
            attributes = {
              ...
              "elastic_load_balancer"         => layer.elastic_load_balancer,
              "system_packages"               => layer.system_packages,
              "custom_json"                   => layer.custom_json,
              "ebs_volume.mount_point"        => layer.ebs_volume.mount_point,
              "ebs_volume.size"               => layer.ebs_volume.size,
              "ebs_volume.number_of_disks"    => layer.ebs_volume.number_of_disks,
              "ebs_volume.raid_level"         => layer.ebs_volume.raid_level,
              "ebs_volume.type"               => layer.ebs_volume.type,
              "ebs_volume.iops"               => layer.ebs_volume.iops
            }
